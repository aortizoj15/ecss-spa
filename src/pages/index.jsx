...
const IndexPage = () => (
  <Layout>
    ...
    <section className="about">
      ...
      // className="text-base font-normal leading-relaxed pt-3 max-w-prose mx-auto md:text-lg"
      >
    ...
    {/* <section className="border-8 border-blue-700"> */}
    <section>
      <div className="w-11/12 h-3/4 m-auto bg-white p-4 max-w-5xl">
        <h2 className="text-2xl md:text-3xl lg:text-5xl font-medium pt-10 md:pt-16">Kitchen Refinishing</h2>
        <div className="grid grid-cols-3">
          <div>
            <StaticImage
              ...
              alt=""
            />
            <hr className="w-1/2 m-auto mb-2 bg-blue-700" />
    ...
    <section className="bg-blue-700 text-white text-center">
      <h2 className="text-2xl md:text-3xl lg:text-5xl font-medium pt-16">Contact Information</h2>
      {/* <div className="flex justify-center align-center flex-wrap align-middle flex-col"> */}
